...
class ManualResult extends StatefulWidget {
  ManualResult(this.farmName, this.choices, this.titleGroup, this.index);
  ...
  @override
  _ManualResultState createState() => _ManualResultState(
    this.farmName, 
    this.choices, 
    this.titleGroup,
    this.index
...
class _ManualResultState extends State<ManualResult> {
        ...
        Expanded(
          ...
          child: ListView(
            children: [
              ...
              _tile(Icons.grid_view, "BBCH " + choices.finalBBCH, toBeginningOfSentenceCase(widget.choices.currentStage)),
            ],
          )
        ),
      ],
  ...
  Widget _tile(IconData icon, String title, String subtitle) {
    return Container(
      ...
      child: ListTile(
        ...
        tileColor: widget.index == 4 ? Colors.green.shade800 : Colors.transparent,
        title: Text(title,
        style: TextStyle(
          color: Colors.white,
          fontSize: 20,
